document.getElementById('registrationForm').addEventListener('submit', function(event) {
    ...
    var phonenumberValid = /^1\d{10}$/.test(phonenumber); //simple phonenumber of 10 characters
    ...
    document.getElementById('phonenumberFeedback').textContent = phonenumberValid ? '' : 'Phone number should be 11 characters long starting with the area code of (1), contain numbers only.'
